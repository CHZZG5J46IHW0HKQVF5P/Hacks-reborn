...
#pragma warning (disable: 4996)     // 'This function or variable may be unsafe': strcpy_s, strdup, sprintf, vsnprintf, sscanf, fopen
...
void ImGui::ToggleButton(const char* str_id, bool* v)
{
    ...
    if (ImGui::IsItemHovered())
        col_bg = ImGui::GetColorU32(ImLerp(style.Colors[ImGuiCustom_ToggleButtonHoveredDisable], style.Colors[ImGuiCustom_ToggleButtonHoveredActive], t));
    else
        col_bg = ImGui::GetColorU32(ImLerp(style.Colors[ImGuiCustom_ToggleButtonDisable], style.Colors[ImGuiCustom_ToggleButtonActive], t));
