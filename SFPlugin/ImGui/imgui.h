...
#include <string.h>                 // memset, memmove, memcpy, strlen, strchr, strcpy_s, strcmp
...
namespace ImGui
{
    ...
    IMGUI_API void          ToggleButton(const char* str_id, bool* v);    // button
...
enum ImGuiCol_
{
    ...
    ImGuiCustom_ToggleButtonActive,
    ImGuiCustom_ToggleButtonHoveredActive,
    ImGuiCustom_ToggleButtonHoveredDisable,
    ImGuiCustom_ToggleButtonDisable,
    ImGuiCol_COUNT
